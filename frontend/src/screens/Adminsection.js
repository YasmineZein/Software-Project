...
export default function Adminsection() {
  ...
  const editcode=async(_id,Name,Blocks)=>{
      setInputs2((prev)=>({
        _id:_id,
        Name:Name,
        Blocks:Blocks,
            ...
            <tbody>
                ...
                {qs.map((code,i)=>{
                  return(<tr>
                          <td>{code.Name}</td>
                          <td>
                            <i className="fa-solid fa-pen" onClick={()=>editcode(code._id,code.Name,code.Blocks)}></i>
