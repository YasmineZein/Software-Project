...
export default function Admincourse() {
  ...
  const submithandler=(e)=>{
    ...
    Axios.post( 
      ...
      {...inputs,Sections:qscodes,Private:isprivate.current.checked,Isfree:isfree.current.checked,Img:avatar},
      config
    ).then((response)=>{
      setloadingcode(true);
      const Toast = Swal.mixin({
  ...
  const editcode=async(_id,Name,Sections,Private,Price,Isfree,Instructor,Qimg)=>{
      setInputs2((prev)=>({
        _id:_id,
        Name:Name,
        Sections:Sections,
      ...
      instructorref.current.value=Instructor;
      console.log(instructorref.current.value);
    ...
    const submithandler2=(e)=>{
      ...
      Axios.post( 
        ...
        {...inputs2,Sections:qscodes,Private:privateedit.current.checked,Isfree:isfreeedit.current.checked,Img:avatar.replace(BACKEND_DOMAIN, "")},
        config
      ).then((response)=>{
        setloadingcode(true);
        const Toast = Swal.mixin({
            ...
            <tbody>
                ...
                {qs.map((code,i)=>{
                  return(<tr>
                          ...
                          <td>{code.Isfree?"مجاني":"مدفوع"}</td>
                          <td>{code.Price}</td>
                          <td>{code.Instructor.Name}</td>
                          
                        
                          <td><img src={BACKEND_DOMAIN+code.Img} className='q' alt="teacherimg" style={{"width":"100px"}}/></td>
                          <td>{
                            /*(_id,Name,Sections,Private,Price,Isfree,Instructor,Qimg) */
                            }
                            <i className="fa-solid fa-pen" onClick={()=>editcode(code._id,code.Name,code.Sections,code.Private,code.Price,code.Isfree,code.Instructor._id,code.Img)}></i>
 ...
 */}
        ...
        <div className='add bigpanel' ref={addpanel}>
          <div className='toright'>
           ...
           <div className='imguploader'>
            <h3 style={{"textAlign":"center","marginBottom":"20px"}}>صورة الكورس</h3>
          ...
          <label class="container-checkbox">is free
            <input type="checkbox" name='Isfree'ref={isfree}/>
          ...
          <label class="container-checkbox">is private
            ...
            <div className='search'>
              ...
              <input type="text" placeholder="ابحث" onFocus={()=>setshowsearch(true)} onBlur={()=>setTimeout(() => {setshowsearch(false)}, 300)} ref={searchqinput} name='search'/>
        ...
        <div className='add bigpanel' ref={editpanel}>
          ...
          */}
          ...
          <label class="container-checkbox">is free
            <input type="checkbox" ref={isfreeedit} name='Isfree'/>
            <span class="checkmark"></span>
          </label>
          ...
          <h1 style={{"textAlign":"center"}}>السكشنز</h1>
            ...
            <div className='search'>
              ...
              <input type="text" placeholder="ابحث" onFocus={()=>setshowsearchedit(true)} onBlur={()=>setTimeout(() => {setshowsearchedit(false)}, 300)} ref={searchqinputedit} name='search'/>
            ...
            <select  name="Instructor" onChange={handleChange2} ref={instructorref}>
              <option value="null" >اختار المعلم</option>
                {
                  instructors.map((e)=>{
                    return(
